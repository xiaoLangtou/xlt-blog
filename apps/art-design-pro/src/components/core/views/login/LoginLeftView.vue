...
<style lang="scss" scoped>
  .login-left-view {
    ...
    .left-img {
      ...
      animation:
        ...
        float 6s ease-in-out 0.6s infinite;
    }
  ...
  .dark .login-left-view {
    background: linear-gradient(
      135deg,
      color-mix(in srgb, var(--el-color-primary) 40%, #0a0a0a) 0%,
      color-mix(in srgb, var(--el-color-primary) 60%, #111) 50%,
      color-mix(in srgb, var(--el-color-primary-dark-2) 80%, #000) 100%
    );
    ...
    .geometric-decorations {
      ...
      .circle-top-right {
        ...
        &::before {
          ...
          height: 50px;
          content: '';
          background-color: color-mix(in srgb, var(--el-color-primary-dark-2) 80%, #000);
          border-radius: 50%;
