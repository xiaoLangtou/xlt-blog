...
export const THEME_COLORS: ThemeColorOption[] = [
  { name: 'black', label: '黑', color: '#151312' },
  { name: 'orange-brown', label: '橙棕', color: '#AB3A00' },
  { name: 'blue', label: '蓝', color: '#102ADF' },
  { name: 'indigo', label: '靛蓝', color: '#006183' },
  { name: 'deep-green', label: '深绿', color: '#006944' },
  { name: 'purple-red', label: '紫红', color: '#9600A9' },
  { name: 'green', label: '绿', color: '#007229' },
  { name: 'blue-violet', label: '蓝紫', color: '#330BCE' },
  { name: 'yellow-green', label: '黄绿', color: '#8CE600' },
  { name: 'red-brown', label: '红棕', color: '#BC2200' },
  { name: 'rose-red', label: '玫红', color: '#B8004A' },
  { name: 'purple', label: '紫', color: '#6D00D1' },
  { name: 'red', label: '红', color: '#B2000A' },
  { name: 'deep-red', label: '深红', color: '#B80029' },
  { name: 'deep-blue', label: '深蓝', color: '#005498' },
  { name: 'dark-green', label: '墨绿', color: '#00665C' },
  { name: 'bright-purple', label: '亮紫', color: '#5C00E1' },
  { name: 'gold', label: '金黄', color: '#FCBE00' },
]

export const DEFAULT_THEME_COLOR = 'red-brown'
